 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */var nt;const vn=((nt=window.HTMLSlotElement)===null||nt===void 0?void 0:nt.prototype.assignedElements)!=null?(s,n)=>s.assignedElements(n):(s,n)=>s.assignedNodes(n).filter(i=>i.nodeType===Node.ELEMENT_NODE);function ks(s){const{slot:n,selector:i}=s??{};return o({descriptor:r=>({get(){var a;const l="slot"+(n?`[name=${n}]`:":not([name])"),c=(a=this.renderRoot)===null||a===void 0?void 0:a.querySelector(l),d=c!=null?vn(c,s):[];return i?d.filter(h=>h.matches(i)):d},enumerable:!0,configurable:!0})})}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function Ss(s,n,i){let r,a=s;return typeof s=="object"?(a=s.slot,r=s):r={flatten:n},i?t({slot:a,flatten:n,selector:i}):e({descriptor:l=>({get(){var c,d;const h="slot"+(a?`[name=${a}]`:":not([name])"),u=(c=this.renderRoot)===null||c===void 0?void 0:c.querySelector(h);return(d=u?.assignedNodes(r))!==null&&d!==void 0?d:[]},enumerable:!0,configurable:!0})})}var yn=Object.defineProperty,_n=Object.getOwnPropertyDescriptor,it=(s,n,i,r)=>{for(var a=r>1?void 0:r?_n(n,i):n,l=s.length-1,c;l>=0;l--)(c=s[l])&&(a=(r?c(n,i,a):c(a))||a);return r&&a&&yn(n,i,a),a};let ye=class extends B{constructor(){super(...arguments),this.icon="",this.modifier=""}render(){return H``}};ye.styles=X`
		:host {
	...
	`,z([g()],D.prototype,"name",2),z([g()],D.prototype,"email",2),z([g()],D.prototype,"date",2),z([g()],D.prototype,"avatar",2),z([g()],D.prototype,"dateFormat",2),z([g({type:Boolean,reflect:!0})],D.prototype,"committer",2),z([g()],D.prototype,"actionLabel",2),D=z([K("commit-identity")],D);var On=Object.defineProperty,Bn=Object.getOwnPropertyDescriptor,re=(s,n,i,r)=>{for(var a=r>1?void 0:r?Bn(n,i):n,l=s.length-1,c;l>=0;l--)(c=s[l])&&(a=(r?c(n,i,a):c(a))||a);return r&&a&&On(n,i,a),a};let q=class extends B{constructor(){super(...arguments),this.url="",this.name="",this.date="",this.status="merged",this.key="#1999"}render(){const s=this.status.toLowerCase()==="merged"?"git-merge":this.status.toLowerCase()==="closed"?"pass":"issues";return H`
	...
	`,re([g()],q.prototype,"url",2),re([g()],q.prototype,"name",2),re([g()],q.prototype,"date",2),re([g()],q.prototype,"status",2),re([g()],q.prototype,"key",2),q=re([K("issue-pull-request")],q);var Nn=Object.defineProperty,Mn=Object.getOwnPropertyDescriptor,lo=(s,n,i,r)=>{for(var a=r>1?void 0:r?Mn(n,i):n,l=s.length-1,c;l>=0;l--)(c=s[l])&&(a=(r?c(n,i,a):c(a))||a);return r&&a&&Nn(n,i,a),a};let Me=class extends B{constructor(){super(...arguments),this.lines=1}render(){const s=`--skeleton-lines: ${this.lines};`;return H`<div class="skeleton" style=${s}></div>`}};Me.styles=X`
		:host {
	...
	`,lo([g({type:Number})],Me.prototype,"lines",2),Me=lo([K("skeleton-loader")],Me);var Dn=Object.defineProperty,In=Object.getOwnPropertyDescriptor,De=(s,n,i,r)=>{for(var a=r>1?void 0:r?In(n,i):n,l=s.length-1,c;l>=0;l--)(c=s[l])&&(a=(r?c(n,i,a):c(a))||a);return r&&a&&Dn(n,i,a),a};let ae=class extends B{constructor(){super(...arguments),this.added=0,this.modified=0,this.removed=0}render(){return H`
...
`;let yt=class extends le{actionNodesChanged(s,n){if(this.actionNodesDisposer?.(),!n?.length)return;const i=this.handleKeydown.bind(this),r=n?.filter(a=>a.nodeType===1).map((a,l)=>(a.setAttribute("tabindex",l===0?"0":"-1"),a.addEventListener("keydown",i,!1),{dispose:()=>{a?.removeEventListener("keydown",i,!1)}}));this.actionNodesDisposer=()=>{r?.forEach(({dispose:a})=>a())}}disconnectedCallback(){this.actionNodesDisposer?.()}handleKeydown(s){if(!s.target||this.actionNodes==null||this.actionNodes.length<2)return;const n=s.target;let i=null;if(s.key==="ArrowLeft"){if(i=n.previousElementSibling,i==null){const r=this.actionNodes.filter(a=>a.nodeType===1);i=r[r.length-1]??null}}else s.key==="ArrowRight"&&(i=n.nextElementSibling,i==null&&(i=this.actionNodes.find(r=>r.nodeType===1)??null));i==null||i===n||(n.setAttribute("tabindex","-1"),i.setAttribute("tabindex","0"),i.focus())}};Eo([po],yt.prototype,"actionNodes",2),yt=Eo([he({name:"action-nav",template:di,styles:ui})],yt);var fi=Object.defineProperty,bi=Object.getOwnPropertyDescriptor,Ue=(s,n,i,r)=>{for(var a=r>1?void 0:r?bi(n,i):n,l=s.length-1,c;l>=0;l--)(c=s[l])&&(a=(r?c(n,i,a):c(a))||a);return r&&a&&fi(n,i,a),a};let de=class extends B{constructor(){super(...arguments),this.collapsable=!1,this.expanded=!1,this.loading=!1}renderTitle(){return this.collapsable?H`<button
	...
	`,Ue([g({type:Boolean,reflect:!0})],de.prototype,"collapsable",2),Ue([g({type:Boolean,reflect:!0})],de.prototype,"expanded",2),Ue([g({type:Boolean,reflect:!0})],de.prototype,"loading",2),de=Ue([K("webview-pane")],de);var pi=Object.defineProperty,mi=Object.getOwnPropertyDescriptor,_t=(s,n,i,r)=>{for(var a=r>1?void 0:r?mi(n,i):n,l=s.length-1,c;l>=0;l--)(c=s[l])&&(a=(r?c(n,i,a):c(a))||a);return r&&a&&pi(n,i,a),a};const gi=N`
...
`;let je=class extends le{constructor(){super(...arguments),this.mode="infinite",this.active=!1}};_t([y({mode:"reflect"})],je.prototype,"mode",2),_t([y({mode:"boolean"})],je.prototype,"active",2),je=_t([he({name:"progress-indicator",template:gi,styles:vi})],je);var yi=Object.defineProperty,_i=Object.getOwnPropertyDescriptor,Oo=(s,n,i,r)=>{for(var a=r>1?void 0:r?_i(n,i):n,l=s.length-1,c;l>=0;l--)(c=s[l])&&(a=(r?c(n,i,a):c(a))||a);return r&&a&&yi(n,i,a),a};const wi=N`
	<template role="tree">
...
`;let wt=class extends le{itemNodesChanged(s,n){if(this.itemNodesDisposer?.(),!n?.length)return;const i=n?.filter(r=>r.nodeType===1).map(r=>{const a=this.handleKeydown.bind(this),l=this.handleBeforeSelected.bind(this),c=this.handleSelected.bind(this);return r.addEventListener("keydown",a,!1),r.addEventListener("select",l,!1),r.addEventListener("selected",c,!1),{dispose:function(){r?.removeEventListener("keydown",a,!1),r?.removeEventListener("select",l,!1),r?.removeEventListener("selected",c,!1)}}});this.itemNodesDisposer=()=>{i?.forEach(({dispose:r})=>r())}}disconnectedCallback(){this.itemNodesDisposer?.()}handleBeforeSelected(s){if(!s.target)return;const n=s.target;this._lastSelected!=null&&this._lastSelected!==n&&this._lastSelected.deselect(),this._lastSelected=n}handleSelected(s){if(!s.target||!s.detail.branch)return;const n=s.target,i=n.getAttribute("level"),r=c=>parseInt(c.getAttribute("level")??"0",10),a=c=>{const d=r(c);let h=c.previousElementSibling;for(;h;){if(r(h)<d)return h;h=h.previousElementSibling}};let l=n.nextElementSibling;for(;l&&l.getAttribute("level")!==i;){const c=a(l);l.setAttribute("parentexpanded",c?.expanded===!1?"false":"true"),l.setAttribute("expanded",s.detail.expanded?"true":"false"),l=l.nextElementSibling}}handleKeydown(s){if(!s.target)return;const n=s.target;s.key==="Enter"||s.key===" "?n.select(s.key==="Enter"?{preserveFocus:!1}:void 0):s.key==="ArrowUp"?n.previousElementSibling?.focus():s.key==="ArrowDown"&&n.nextElementSibling?.focus()}};Oo([po],wt.prototype,"itemNodes",2),wt=Oo([he({name:"list-container",template:wi,styles:$i})],wt);function M(s,n,i){return{index:s,removed:n,addedCount:i}}const Bo=0,No=1,$t=2,xt=3;function xi(s,n,i,r,a,l){const c=l-a+1,d=i-n+1,h=new Array(c);let u,b;for(let f=0;f<c;++f)h[f]=new Array(d),h[f][0]=f;for(let f=0;f<d;++f)h[0][f]=f;for(let f=1;f<c;++f)for(let p=1;p<d;++p)s[n+p-1]===r[a+f-1]?h[f][p]=h[f-1][p-1]:(u=h[f-1][p]+1,b=h[f][p-1]+1,h[f][p]=u<b?u:b);return h}function Ci(s){let n=s.length-1,i=s[0].length-1,r=s[n][i];const a=[];for(;n>0||i>0;){if(n===0){a.push($t),i--;continue}if(i===0){a.push(xt),n--;continue}const l=s[n-1][i-1],c=s[n-1][i],d=s[n][i-1];let h;c<d?h=c<l?c:l:h=d<l?d:l,h===l?(l===r?a.push(Bo):(a.push(No),r=l),n--,i--):h===c?(a.push(xt),n--,r=c):(a.push($t),i--,r=d)}return a.reverse(),a}function ki(s,n,i){for(let r=0;r<i;++r)if(s[r]!==n[r])return r;return i}function Si(s,n,i){let r=s.length,a=n.length,l=0;for(;l<i&&s[--r]===n[--a];)l++;return l}function Ai(s,n,i,r){return n<i||r<s?-1:n===i||r===s?0:s<i?n<r?n-i:r-i:r<n?r-s:n-s}function Mo(s,n,i,r,a,l){let c=0,d=0;const h=Math.min(i-n,l-a);if(n===0&&a===0&&(c=ki(s,r,h)),i===s.length&&l===r.length&&(d=Si(s,r,h-c)),n+=c,a+=c,i-=d,l-=d,i-n===0&&l-a===0)return at;if(n===i){const _=M(n,[],0);for(;a<l;)_.removed.push(r[a++]);return[_]}else if(a===l)return[M(n,[],i-n)];const u=Ci(xi(s,n,i,r,a,l)),b=[];let f,p=n,m=a;for(let _=0;_<u.length;++_)switch(u[_]){case Bo:f!==void 0&&(b.push(f),f=void 0),p++,m++;break;case No:f===void 0&&(f=M(p,[],0)),f.addedCount++,p++,f.removed.push(r[m]),m++;break;case $t:f===void 0&&(f=M(p,[],0)),f.addedCount++,p++;break;case xt:f===void 0&&(f=M(p,[],0)),f.removed.push(r[m]),m++;break}return f!==void 0&&b.push(f),b}const Do=Array.prototype.push;function Pi(s,n,i,r){const a=M(n,i,r);let l=!1,c=0;for(let d=0;d<s.length;d++){const h=s[d];if(h.index+=c,l)continue;const u=Ai(a.index,a.index+a.removed.length,h.index,h.index+h.addedCount);if(u>=0){s.splice(d,1),d--,c-=h.addedCount-h.removed.length,a.addedCount+=h.addedCount-u;const b=a.removed.length+h.removed.length-u;if(!a.addedCount&&!b)l=!0;else{let f=h.removed;if(a.index<h.index){const p=a.removed.slice(0,h.index-a.index);Do.apply(p,f),f=p}if(a.index+a.removed.length>h.index+h.addedCount){const p=a.removed.slice(h.index+h.addedCount-a.index);Do.apply(f,p)}a.removed=f,h.index<a.index&&(a.index=h.index)}}else if(a.index<h.index){l=!0,s.splice(d,0,a),d++;const b=a.addedCount-a.removed.length;h.index+=b,c+=b}}l||s.push(a)}function Ti(s){const n=[];for(let i=0,r=s.length;i<r;i++){const a=s[i];Pi(n,a.index,a.removed,a.addedCount)}return n}function Ei(s,n){let i=[];const r=Ti(n);for(let a=0,l=r.length;a<l;++a){const c=r[a];if(c.addedCount===1&&c.removed.length===1){c.removed[0]!==s[c.index]&&i.push(c);continue}i=i.concat(Mo(s,c.index,c.index+c.addedCount,c.removed,0,c.removed.length))}return i}let Io=!1;function Ct(s,n){let i=s.index;const r=n.length;return i>r?i=r-s.addedCount:i<0&&(i=r+s.removed.length+i-s.addedCount),i<0&&(i=0),s.index=i,s}class Oi extends Ie{constructor(n){super(n),this.oldCollection=void 0,this.splices=void 0,this.needsQueue=!0,this.call=this.flush,Reflect.defineProperty(n,"$fastController",{value:this,enumerable:!1})}subscribe(n){this.flush(),super.subscribe(n)}addSplice(n){this.splices===void 0?this.splices=[n]:this.splices.push(n),this.needsQueue&&(this.needsQueue=!1,w.queueUpdate(this))}reset(n){this.oldCollection=n,this.needsQueue&&(this.needsQueue=!1,w.queueUpdate(this))}flush(){const n=this.splices,i=this.oldCollection;if(n===void 0&&i===void 0)return;this.needsQueue=!0,this.splices=void 0,this.oldCollection=void 0;const r=i===void 0?Ei(this.source,n):Mo(this.source,0,this.source.length,i,0,i.length);this.notify(r)}}function Bi(){if(Io)return;Io=!0,k.setArrayObserverFactory(h=>new Oi(h));const s=Array.prototype;if(s.$fastPatch)return;Reflect.defineProperty(s,"$fastPatch",{value:1,enumerable:!1});const n=s.pop,i=s.push,r=s.reverse,a=s.shift,l=s.sort,c=s.splice,d=s.unshift;s.pop=function(){const h=this.length>0,u=n.apply(this,arguments),b=this.$fastController;return b!==void 0&&h&&b.addSplice(M(this.length,[u],0)),u},s.push=function(){const h=i.apply(this,arguments),u=this.$fastController;return u!==void 0&&u.addSplice(Ct(M(this.length-arguments.length,[],arguments.length),this)),h},s.reverse=function(){let h;const u=this.$fastController;u!==void 0&&(u.flush(),h=this.slice());const b=r.apply(this,arguments);return u!==void 0&&u.reset(h),b},s.shift=function(){const h=this.length>0,u=a.apply(this,arguments),b=this.$fastController;return b!==void 0&&h&&b.addSplice(M(0,[u],0)),u},s.sort=function(){let h;const u=this.$fastController;u!==void 0&&(u.flush(),h=this.slice());const b=l.apply(this,arguments);return u!==void 0&&u.reset(h),b},s.splice=function(){const h=c.apply(this,arguments),u=this.$fastController;return u!==void 0&&u.addSplice(Ct(M(+arguments[0],h,arguments.length>2?arguments.length-2:0),this)),h},s.unshift=function(){const h=d.apply(this,arguments),u=this.$fastController;return u!==void 0&&u.addSplice(Ct(M(0,[],arguments.length),this)),h}}const Fo=Object.freeze({positioning:!1,recycle:!0});function Ni(s,n,i,r){s.bind(n[i],r)}function Mi(s,n,i,r){const a=Object.create(r);a.index=i,a.length=n.length,s.bind(n[i],a)}class Di{constructor(n,i,r,a,l,c){this.location=n,this.itemsBinding=i,this.templateBinding=a,this.options=c,this.source=null,this.views=[],this.items=null,this.itemsObserver=null,this.originalContext=void 0,this.childContext=void 0,this.bindView=Ni,this.itemsBindingObserver=k.binding(i,this,r),this.templateBindingObserver=k.binding(a,this,l),c.positioning&&(this.bindView=Mi)}bind(n,i){this.source=n,this.originalContext=i,this.childContext=Object.create(i),this.childContext.parent=n,this.childContext.parentContext=this.originalContext,this.items=this.itemsBindingObserver.observe(n,this.originalContext),this.template=this.templateBindingObserver.observe(n,this.originalContext),this.observeItems(!0),this.refreshAllViews()}unbind(){this.source=null,this.items=null,this.itemsObserver!==null&&this.itemsObserver.unsubscribe(this),this.unbindAllViews(),this.itemsBindingObserver.disconnect(),this.templateBindingObserver.disconnect()}handleChange(n,i){n===this.itemsBinding?(this.items=this.itemsBindingObserver.observe(this.source,this.originalContext),this.observeItems(),this.refreshAllViews()):n===this.templateBinding?(this.template=this.templateBindingObserver.observe(this.source,this.originalContext),this.refreshAllViews(!0)):this.updateViews(i)}observeItems(n=!1){if(!this.items){this.items=at;return}const i=this.itemsObserver,r=this.itemsObserver=k.getNotifier(this.items),a=i!==r;a&&i!==null&&i.unsubscribe(this),(a||n)&&r.subscribe(this)}updateViews(n){const i=this.childContext,r=this.views,a=this.bindView,l=this.items,c=this.template,d=this.options.recycle,h=[];let u=0,b=0;for(let f=0,p=n.length;f<p;++f){const m=n[f],_=m.removed;let $=0,L=m.index;const Ho=L+m.addedCount,ue=r.splice(m.index,_.length);for(b=h.length+ue.length;L<Ho;++L){const kt=r[L],Vo=kt?kt.firstChild:this.location;let G;d&&b>0?($<=b&&ue.length>0?(G=ue[$],$++):(G=h[u],u++),b--):G=c.create(),r.splice(L,0,G),a(G,l,L,i),G.insertBefore(Vo)}ue[$]&&h.push(...ue.slice($))}for(let f=u,p=h.length;f<p;++f)h[f].dispose();if(this.options.positioning)for(let f=0,p=r.length;f<p;++f){const m=r[f].context;m.length=p,m.index=f}}refreshAllViews(n=!1){const i=this.items,r=this.childContext,a=this.template,l=this.location,c=this.bindView;let d=i.length,h=this.views,u=h.length;if((d===0||n||!this.options.recycle)&&(wo.disposeContiguousBatch(h),u=0),u===0){this.views=h=new Array(d);for(let b=0;b<d;++b){const f=a.create();c(f,i,b,r),h[b]=f,f.insertBefore(l)}}else{let b=0;for(;b<d;++b)if(b<u){const p=h[b];c(p,i,b,r)}else{const p=a.create();c(p,i,b,r),h.push(p),p.insertBefore(l)}const f=h.splice(b,u-b);for(b=0,d=f.length;b<d;++b)f[b].dispose()}}unbindAllViews(){const n=this.views;for(let i=0,r=n.length;i<r;++i)n[i].unbind()}}class Ii extends Re{constructor(n,i,r){super(),this.itemsBinding=n,this.templateBinding=i,this.options=r,this.createPlaceholder=w.createBlockPlaceholder,Bi(),this.isItemsBindingVolatile=k.isVolatileBinding(n),this.isTemplateBindingVolatile=k.isVolatileBinding(i)}createBehavior(n){return new Di(n,this.itemsBinding,this.isItemsBindingVolatile,this.templateBinding,this.isTemplateBindingVolatile,this.options)}}function Fi(s,n,i=Fo){const r=typeof n=="function"?n:()=>n;return new Ii(s,r,Object.assign(Object.assign({},Fo),i))}function ze(s,n){const i=typeof n=="function"?n:()=>n;return(r,a)=>s(r,a)?i(r,a):null}const Lo={toView:function(s){return s.toString()},fromView:function(s){return parseInt(s,10)}};var Li=Object.defineProperty,Ri=Object.getOwnPropertyDescriptor,V=(s,n,i,r)=>{for(var a=r>1?void 0:r?Ri(n,i):n,l=s.length-1,c;l>=0;l--)(c=s[l])&&(a=(r?c(n,i,a):c(a))||a);return r&&a&&Li(n,i,a),a};const Hi=N`
	<template
		role="treeitem"
